...
></span>
		<form method="post" name="profile-form" id="profile-form">
			<fieldset id="profile-set">
				...
				<input class="active-entry" type="password" maxlength="50"  name="password" id="password" value=""/>
				...
				<select class="required active-entry" name="position" id="position" disabled="disabled">
